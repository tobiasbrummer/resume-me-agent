...
% --- Schrift: Fira Sans via fontspec (lualatex / xelatex) ---
% Ligatures=TeX aktiviert die klassischen TeX-Glyph-Ligaturen:
%   --   -> en-dash (–)         ---  -> em-dash (—)
%   ``''  -> typografische Anfuehrungszeichen
%   <<>>  -> franzoesische Guillemets
% Nur Glyph-Substitution beim Rendern -- die Tokens auf TeX-Ebene bleiben
% unveraendert, d.h. \IfSubStr{...}{--} funktioniert weiter (siehe \cvsubsection).
\usepackage{fontspec}
...
\newfontfamily\fontsemibold{Fira Sans SemiBold}[Ligatures={Common,TeX}, Kerning=On, StylisticSet={1}, Style=Alternate]
\newfontfamily\fontmedium{Fira Sans Medium}[Ligatures={Common,TeX}, Kerning=On, StylisticSet={1}, Style=Alternate]
\newfontfamily\fontregular{Fira Sans Regular}[Ligatures={Common,TeX}, Kerning=On, StylisticSet={1}, Style=Alternate]
\newfontfamily\fontitalic{Fira Sans Italic}[Ligatures={Common,TeX}, Kerning=On, StylisticSet={1}, Style=Alternate]
